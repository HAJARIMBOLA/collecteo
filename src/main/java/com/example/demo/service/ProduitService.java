...
public class ProduitService {
  ...
  /**
   * Diminue le stock après une vente et met à jour le dernier prix moyen de vente. Vérifie ici même
   * que le stock est suffisant (et pas seulement dans VenteService qui appelle cette méthode), pour
   * qu'un futur appelant ne puisse jamais faire passer le stock en négatif en oubliant ce contrôle
   * en amont.
   */
